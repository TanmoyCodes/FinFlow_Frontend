...
const InteractiveSection = () => {
  ...
  return (
    <section className="py-32 px-6 bg-dark-900/40">
          ...
          <p className="text-slate-400 text-lg leading-relaxed">
            ...
            <div className="space-y-4">
              <div className="flex justify-between font-bold">
                <span className="flex items-center gap-2"><FiDollarSign className="text-primary-400" /> Annual Income</span>
                <span className="text-primary-400">₹{income.toLocaleString()}</span>
              </div>
              <input 
            ...
            <div className="space-y-4">
              <div className="flex justify-between font-bold">
                <span className="flex items-center gap-2"><FiActivity className="text-primary-400" /> Loan Amount</span>
                <span className="text-primary-400">₹{amount.toLocaleString()}</span>
              </div>
              <input 
            ...
            <div className="space-y-4">
              <div className="flex justify-between font-bold">
                <span className="flex items-center gap-2"><FiCalendar className="text-primary-400" /> Tenure (Months)</span>
                <span className="text-primary-400">{tenure} Months</span>
              </div>
              <input 
        ...
        >
          ...
          <div className="relative glass-card rounded-[3rem] p-12 border border-white/10 text-center space-y-10 shadow-2xl">
            <div className="space-y-2">
              <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">Estimated Approval</p>
              <div className="text-7xl font-display font-bold gradient-text">{approval}%</div>
            </div>

            <div className="h-px bg-white/10 mx-auto w-1/2"></div>
            ...
            <button className="w-full py-5 bg-white text-dark-900 rounded-2xl font-bold text-lg hover:bg-slate-50 transition-all hover:shadow-xl active:scale-95">
