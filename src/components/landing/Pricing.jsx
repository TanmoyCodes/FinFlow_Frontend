    ...
    <section id="pricing" className="py-32 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">Choose the plan that fits your financial journey. No hidden fees, ever.</p>
        </div>
          ...
          {plans.map((plan, idx) => (
            <motion.div 
              ...
              className={`relative p-10 rounded-[2.5rem] border ${
                plan.popular 
                  ? 'bg-primary-600/5 border-primary-500 scale-105 shadow-2xl z-10' 
