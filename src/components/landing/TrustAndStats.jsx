      ...
      <div className="space-y-8">
        ...
        <div className="grid sm:grid-cols-2 gap-6 pt-4">
          {[
            ...
            <div key={i} className="flex gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5 hover:border-primary-500/20 transition-all">
...
export const Analytics = () => (
  <section id="analytics" className="py-32 px-6 bg-primary-50/50 dark:bg-dark-900/40 transition-colors duration-500">
    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
      <div className="space-y-8 order-2 lg:order-1">
        ...
        <div className="space-y-6 pt-4">
          {[
            ...
            <div key={i} className="flex items-center justify-between p-6 glass-card rounded-2xl border border-slate-200 dark:border-white/5">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-primary-500/10 rounded-xl flex items-center justify-center text-primary-600 dark:text-primary-400">{item.icon}</div>
                <span className="font-bold">{item.title}</span>
              </div>
              <span className="text-xl font-display font-bold text-primary-700 dark:gradient-text dark:bg-clip-text dark:text-transparent">{item.val}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      >
        <div className="relative glass-card-light dark:glass-card rounded-[2.5rem] border border-slate-200 dark:border-white/10 p-4 shadow-3xl">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {[
          ...
          <motion.div 
            key={i}
            whileHover={{ y: -5 }}
            className="p-10 glass-card rounded-[2.5rem] border border-slate-200 dark:border-white/5 italic text-slate-600 dark:text-slate-300 relative"
          >
            ...
            <div className="flex items-center gap-4 not-italic">
              <div className="w-12 h-12 rounded-full bg-slate-100 dark:bg-dark-700 overflow-hidden">
